---
title: "How To Move A Podcast from Simplecast to Buzzsprout Without Losing Subscribers"
description: "How To Move A Podcast from Simplecast to Buzzsprout Without Losing Subscribers

◎ Step-by-step tutorial ◎"
pubDate: "2022-04-22T22:09:53"
updatedDate: "2023-12-30T09:42:32"
draft: false
type: "post"
slug: "movepodcast"
permalink: "/movepodcast/"
legacyPermalink: "https://www.mikemurphy.co/movepodcast/"
canonicalUrl: "https://mikemurphy.ai/movepodcast/"
contentEra: "legacy"
visibility: "search"
author: "Mike Murphy"
featuredImage: "/assets/media/2022/04/SC-TO-BUZZ.jpeg"
featuredImageSource: "https://www.mikemurphy.co/wp-content/uploads/2022/04/SC-TO-BUZZ.jpeg"
categories: 
  - "Blog"
  - "Podcasting"
tags: 
...
wp:
  ...
  rawWordCount: 3813
seo:
  legacyTitle: "How To Move A Podcast from Simplecast to Buzzsprout Without Losing Subscribers - Mike Murphy Co"
  legacyH1: "How To Move A Podcast from Simplecast to Buzzsprout Without Losing Subscribers"
  legacyCanonical: "https://www.mikemurphy.co/movepodcast/"
  robots: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1"
  liveWordCount: 3812
youtube: []
---
![Simplecast to Buzzsprout](https://cdn-images-1.medium.com/max/1600/1*FnoO5oQoxF3fMKST296MEA.jpeg)

------------------------------------------------------------------------

### **What You Will Learn:**

This is a step-by-step tutorial and guide that will show you how to seamlessly move a podcast (aka, ‘show’) from one podcast hosting company ([Simplecast](https://simplecast.com)) to another ([Buzzsprout](https://buzzsprout.com)) without losing any subscribers or interrupting the show.
...
**Buzzsprout:** Create a new free account at [Buzzsprout.com](https://mikemurphy.co/buzzsrpout)
...
If you sign up for Buzzsprout using my [affiliate link](https://mikemurphy.co/buzzsprout) and upgrade to a paid plan, then I get a small commission and you will receive a \$20 Amazon Gift Card. It’s a win-win, but if you’d rather not, then no big deal. Here is the [non-affiliate link](https://www.buzzsprout.com/sign_up) to sign up for Buzzsprout.

###  

### Tip: Create A Podcast Cheatsheet (+Notion Template)

- To make the process of managing and moving a show much easier, you may consider creating a ‘living’ [master podcast cheatsheet](https://mikemurphy.notion.site/Podcast-Master-Cheatsheet-View-Only-13558225cebe41ee99159b8f989a7827), checklist or SOP (use Apple Notes, Google Docs, Word, Notion, etc) for each podcast you own so you have all show details in one document making it easy to move shows, copy and paste show info, and keep track of everything in one document.
...
- **Do not include passwords** in your cheatsheet. I recommend using a password manager such as [1Password](https://1password.com/) or [LastPass](https://lastpass.com) to save and manage user names and passwords.

> **Use Notion?** [Click here for view-only Cheatshee](https://mikemurphy.notion.site/Podcast-Master-Cheatsheet-View-Only-13558225cebe41ee99159b8f989a7827)t (duplication is turned off, but feel free to copy the text and create your own cheatsheet). The template is mainly intended to be a spark of inspiration for you to create a podcast cheatsheet to fit your own needs and workflow.

> If you want to duplicate the Notion template and get an 8-page PDF Version, it’s available on [Gumroad for \$1.00](https://mikemurphy.gumroad.com/l/pmc) (holla).

> **Notion Template (Duplicate Off) :** [Free View Only Version](https://mikemurphy.notion.site/Podcast-Master-Cheatsheet-View-Only-13558225cebe41ee99159b8f989a7827) (👍)**  
> Notion Template (Duplicate On)+ PDF:** (\$1 on [Gumroad](https://mikemurphy.gumroad.com/l/pmc) 👍👍)

[**Podcast Master Cheatsheet for Show Owners**  
*Do you own or manage a podcast?This is a cheatsheet for podcast/show owners to keep track of all the important show…*mikemurphy.gumroad.com](https://mikemurphy.gumroad.com/l/pmc "https://mikemurphy.gumroad.com/l/pmc")
...
The initial import on the [free plan](https://www.buzzsprout.com/pricing) will copy 2 episodes and will not impact your show on Simplecast. You are in ‘test mode’ until you set the 301 Redirect on Simplecast which will be one of the last steps in the moving process.

1.  Sign Up For [Buzzsprout](https://www.buzzsprout.com/sign_up) (or use my [affiliate link](https://mikemurphy.co/buzzsprout))
...
10. Log in to [Buzzsprout](https://www.buzzsprout.com/login)
11. Move on to the next section where you upgrade to a paid plan and finish importing the remaining episodes.

 

![](https://cdn-images-1.medium.com/max/1600/1*vJny67Dr2cFdfC8yV4VQpQ.png)  

Create a new Buzzsprout Account

![](https://cdn-images-1.medium.com/max/1600/1*xVaVvklEQmH4P5ERIGuotw.png)  

Find your show using RSS Feed URL

![](https://cdn-images-1.medium.com/max/1600/1*i5P9jaXDkX7LZnSFx70Oqg.png)  

Woohoo! Successfully imported the first few episodes.

#### II. Upgrade To Paid Plan & Complete Import (Buzzsprout)

In order to import or copy all episodes in your Simplecast RSS Feed, you must upgrade to a [paid plan](https://www.buzzsprout.com/pricing) on Buzzsprout.
...
2.  Select [Plan](https://www.buzzsprout.com/1973705/subscriptions/1974092/plans) and click ‘Upgrade’
...
[![](https://cdn-images-1.medium.com/max/1600/1*MC_wbEh_G14e32_-3EtltQ.png)](https://www.buzzsprout.com/pricing)  

Select A Paid Plan To Copy All Episodes

![](https://cdn-images-1.medium.com/max/1600/1*Fc1f1Qp8IL273NpXTuFHUQ.png)  

Enter Credit Card Info

![](https://cdn-images-1.medium.com/max/1600/1*-nCKUZTjJPcOD0dtzpgBkw.png)  
...
![](https://cdn-images-1.medium.com/max/1600/1*Scs4TPyptGUhUUVtFoNxuA.png)  

Explore Dashboard Links & Set Everything Up

![](https://cdn-images-1.medium.com/max/1600/1*RNAtdYPvElpzjWa3Qucl8Q.png)  

Customize Show Website URL

![](https://cdn-images-1.medium.com/max/1600/1*amwg6qYHzJIdpl_mFyLijA.png)  

Add Show Directory URLs in the ‘Directories’ tab on Buzzsprout

![](https://cdn-images-1.medium.com/max/1600/1*lG7q843g21eZNRA0sEnTMw.png)  
...
![](https://cdn-images-1.medium.com/max/1600/1*JCu9M4C3joDtvJ8D_DRUSw.png)  

Customize Buzzsprout Web Embed Players

![](https://cdn-images-1.medium.com/max/1600/1*qb45scFgkByH4j2lrjmBqA.png)  

Click ‘Embed this One Episode’ to Copy Embed Code

![](https://cdn-images-1.medium.com/max/1600/1*__-A-Wz6VOwXaRkgf9wfeQ.png)  

Copy iFrame Embed Code if using Divi Theme on WordPress

![](https://cdn-images-1.medium.com/max/1600/1*qYhkUEWcADONT0uEczNfLA.png)  
...
2.  Sign in to the [Simplecast Dashboard](https://auth.simplecast.com)
...
![](https://cdn-images-1.medium.com/max/1600/1*YR0dB149ANrQHUDPP4_Yuw.png)  

Copy RSS Feed URL on Buzzsprout to set 301 Redirect on Simplecast

![](https://cdn-images-1.medium.com/max/1600/1*F5zlYX-we5q7UOsnWluYkA.png)  

Show Distribution Settings (Simplecast)

![](https://cdn-images-1.medium.com/max/1600/1*7YwxUkQpZDVE2Pb-Y30jtg.png)  
...
1.  **iHeart Radio**  
    Email to Request Manual Update: [help@iheartradio.com](mailto:help@iheartradio.com)
2.  **Pandora**  
    Submit Support Ticket To Update: [https://help.pandora.com/s/contactsupport?language=en_US](https://help.pandora.com/s/contactsupport?language=en_US)
3.  **Stitcher  
    **Log In to [Partners’ Portal](https://partners.stitcher.com/) To Update**:** [https://partners.stitcher.com/](https://partners.stitcher.com/)

[![](https://cdn-images-1.medium.com/max/1600/1*jzE9cwagWCCztEoJTvmodw.png)](https://partners.stitcher.com/)  
...
2.  [Google Podcasts](https://podcastsmanager.google.com/)
...
![](https://cdn-images-1.medium.com/max/1600/1*QLP-axEYfFUFa5ArtEkbmA.png)  

Click ‘Edit’ to Update RSS Feed on [Apple Podcasts Connect](https://podcastsconnect.apple.com/)

![](https://cdn-images-1.medium.com/max/1600/1*I_qjlosEZcQ43cCrgEi_qg.png)  
...
1.  Sign-in to [Google Podcasts Manager](https://podcastsmanager.google.com/)
...
![](https://cdn-images-1.medium.com/max/1600/1*oPYpUQMMn2YPhQZbM8O8TQ.png)  

Click ‘Gear Icon’ and then ‘Change Served Feed’

![](https://cdn-images-1.medium.com/max/1600/1*JWt-lhpY3DkHXtzFOmdJLw.png)  

Enter Buzzsprout RSS Feed and click on ‘Next Step’

![](https://cdn-images-1.medium.com/max/1600/1*DbbxFYlD6Ix48prAOJ6m7A.png)  
...
This list is included in the [Podcast Master Cheatsheet](https://mikemurphy.gumroad.com/l/pmc), but feel free to copy/paste in your own document as it should come in handy. Use the list below to search for your show and confirm each directory is updating when you publish new episodes or make changes on Buzzsprout.

> 📌 **Bonus Tip:** Search for your show on [Podnews.net](http://Podnews.net) to make it easy to find your directory URLs (as well as other useful information). While [Podnews](http://Podnews.net) is a useful and handy resource, it should not be considered your ‘source of truth’ for your show, so always check with your podcast host support team if you discover any discrepancies.
...
1.  **Amazon Music:**  
    Show Listing URL:  
    Dashboard: [https://podcasters.amazon.com/podcasts](https://podcasters.amazon.com/podcasts)  
    Note: RSS Feed automatically updated shortly after 301 Redirect
2.  **Apple Podcasts Connect:**  
    Show Listing URL:  
    Dashboard: [https://podcastsconnect.apple.com/](https://podcastsconnect.apple.com/)
3.  **Audacy:  
    **Show Listing URL:**  
    **To submit new show: [https://www.audacy.com/podcast-submission](https://www.audacy.com/podcast-submission)
4.  **Castbox:**  
    Show Listing URL:  
...
6.  **Deezer:**  
    Show Listing URL:  
    To submit new show: [https://podcasters.deezer.com/submission](https://podcasters.deezer.com/submission)  
    To update RSS Feed: [support@deezer.com](mailto:support@deezer.com)
7.  **Gaana:**  
    Show Listing URL:  
    To submit new show: [https://podcasts.gaana.com/register](https://podcasts.gaana.com/register)  
    To update show: [https://podcasts.gaana.com/](https://podcasts.gaana.com/)
8.  **Google Podcasts Manager:  
    **Show Listing URL:  
    Dashboard: [https://podcastsmanager.google.com/](https://podcastsmanager.google.com/)
9.  **iHeart Radio:  
    **Show Listing URL:  
    Dashboard: [https://podcasters.iheart.com/](https://podcasters.iheart.com/)  
    To Submit a New Show: [https://www.iheart.com/news/submit-your-podcast-15298037/](https://www.iheart.com/news/submit-your-podcast-15298037/)  
    To update RSS Feed: [help@iheartradio.com](mailto:help@iheartradio.com)
10. **JioSaavn:**  
    Show Listing URL:  
    To submit new show: [https://yourcast.jiosaavn.com/](https://yourcast.jiosaavn.com/)  
    To update show: [https://yourcast.jiosaavn.com/dashboard/podcast/8857](https://yourcast.jiosaavn.com/dashboard/podcast/8857) (click ‘Sync’ to refresh feed)
11. **Listen Notes:  
    **Show Listing URL:  
    To submit new show: [https://www.listennotes.com/submit/](https://www.listennotes.com/submit/)
12. **Overcast:**  
    Show Listing URL:  
    Automatically added through Apple Podcasts
13. **Pandora (Amp Login):**  
    Show Listing URL:  
    Dashboard: [https://amp.pandora.com/login](https://amp.pandora.com/login)  
    To submit new show: [https://www.ampplaybook.com/podcasts](https://www.ampplaybook.com/podcasts)  
    To update RSS Feed: [https://help.pandora.com/s/contactsupport?language=en_US](https://help.pandora.com/s/contactsupport?language=en_US)
14. **PlayerFM:**  
    Show Listing URL:  
    To submit new show: [https://player.fm/importer/feed](https://player.fm/importer/feed)
15. **Pocket Casts:**  
    Show Listing URL:  
    To submit new show: [https://pocketcasts.com/submit](https://pocketcasts.com/submit)
16. **Podcast Addict:**  
    Show Listing URL:  
    To submit new show:[https://podcastaddict.com/submit](https://podcastaddict.com/submit)
17. **Podcast Index:  
    **Show Listing URL:  
    To submit new show:[https://podcastindex.org/add](https://podcastindex.org/add)
18. **Podchaser:**  
    Show Listing URL:  
    To submit new show:[https://www.podchaser.com/add](https://www.podchaser.com/add)
19. **Podfriend:  
    **Show Listing URL:**  
...
20. **RadioPublic:**  
    Show Listing URL:  
    To submit new show: [https://podcasters.radiopublic.com/](https://podcasters.radiopublic.com/)  
    Note: Automatically updated shortly after 301 Redirect
21. **Samsung Podcasts:**  
    Show Listing URL:  
    Sign In: [https://cmsweb.glb.samsungcast.com/login](https://cmsweb.glb.samsungcast.com/login)  
    Support: [*spodsupport@samsung.com*](mailto:spodsupport@samsung.com)
22. **Spotify for Podcasters:**  
    Show Listing URL:  
    Dashboard: [https://podcasters.spotify.com](https://podcasters.spotify.com/)  
    Note: RSS Feed automatically updated in less than 12 hours after 301 Redirect
23. **Stitcher Partner Portal:**  
    Show Listing URL:  
    Dashboard: [https://partners.stitcher.com/](https://partners.stitcher.com/)
24. **TuneIn:**  
    Show Listing URL:  
    To submit new show: [https://help.tunein.com/contact/add-podcast-S19TR3Sdf](https://help.tunein.com/contact/add-podcast-S19TR3Sdf)  
    To update existing show: [https://help.tunein.com/how-do-i-update-my-podcast-or-program--H1ax0B7_f](https://help.tunein.com/how-do-i-update-my-podcast-or-program--H1ax0B7_f)

------------------------------------------------------------------------

 

[![](https://cdn-images-1.medium.com/max/1600/1*k6Q_3DVBfVe4kQ7CyNB-8Q.png)](https://mikemurphy.co/youtube)
