...
canonicalUrl: "https://mikemurphy.ai/aeug/"
contentEra: "ai"
visibility: "public"
author: "Mike Murphy"
...
## LEARN ADOBE AFTER EFFECTS IN JUST 6 HOURS!

# Course Trailer

## Master The Essentials. Create With Confidence. Start Using After Effects Today.

- You want to learn After Effects but feel overwhelmed by its complexity
- You need engaging animations for your content—without the endless frustration
- You want your courses & tutorials to stand out with professional animations
- You need eye-catching audiograms and visuals to make your podcast shareable
- You tried After Effects before but got lost in confusing tutorials
- You want to create professional motion graphics without becoming a pro animator
- You're ready to master the essentials and unlock the creative power of After Effects!

## Watch Full Course 👇

#### 1. Getting Started

6 Lessons • 35 Minutes

- Introduction ([YouTube](https://youtu.be/rcyoBHpfoRg))
- Install & Uninstall ([YouTube](https://youtu.be/ZWGcZYSspaM))
- Interface Tour ([YouTube](https://youtu.be/jqyYFrRnLGE))
- Workspaces  & Panels ([YouTube](https://youtu.be/qEMpx603PnU))
- Menus & Preferences ([YouTube](https://youtu.be/sWowmeeSdOU))
- Review & Practice ([YouTube](https://youtu.be/Oe4yKEp9EAA))

#### 2. Projects & Compositions

8 Lessons • 56 Minutes

- Project Folders & Organization ([YouTube](https://youtu.be/AMw_-O5YQio))
- Import Footage ([YouTube](https://youtu.be/dUVH4xGjyI0))
- New Project ([YouTube](https://youtu.be/hdsrnYAueA4))
- Create New Compositions ([YouTube](https://youtu.be/_IIsXMjXWN4))
- Import Photoshop & Illustrator Files ([YouTube](https://youtu.be/dME85-Ns-Uw))
- Layers & Timeline ([YouTube](https://youtu.be/lfTDMaZF9y4))
- Save & Close Projects ([YouTube](https://youtu.be/tKHePpwmUck))
- Review & Practice ([YouTube](https://youtu.be/Ppfk5pDYgJo))

#### 3. Keyframes & Animations

10 Lessons • 96 Minutes

- Keyframes & Animation ([YouTube](https://youtu.be/ScqXTO9ZMxY))
- Anchor Points ([YouTube](https://youtu.be/Ym3nGbraxHA))
- Transform Property Animations ([YouTube](https://youtu.be/WCxXKz3L1yg))
- Text Layers ([YouTube](https://youtu.be/x8CJ2IyEHGo))
- Text Animators ([YouTube](https://youtu.be/ravA6kSC8EI))
- Solid Layers ([YouTube](https://youtu.be/6LjG7zm8DRM))
- Shape Layers ([YouTube](https://youtu.be/X4BSEgeKA_I))
- Layer Masks ([YouTube](https://youtu.be/JFqkUll8MK4))
- Track Mattes ([YouTube](https://youtu.be/U26dotpABXQ))
- Review & Practice ([YouTube](https://youtu.be/6wPJvfmtIdY))

#### 4. Effects & Presets

7 Lessons • 72 Minutes

- Effects ([YouTube](https://youtu.be/rYFxksdSkQE))
- Animation Presets ([YouTube](https://youtu.be/WqjRyGFa004))
- Blend Modes & Layer Styles ([YouTube](https://youtu.be/ImBaBhFWMEo))
- Expressions ([YouTube](https://youtu.be/PTCFltGS4p4))
- Expressions: Loops ([YouTube](https://youtu.be/KbT9SrSnCjI))
- Audio + Effects ([YouTube](https://youtu.be/ep4cMcU3sRY))
- Review & Practice ([YouTube](https://youtu.be/Ky064BCfMrQ))

#### 5. Render & Export

5 Lessons • 51 Minutes

- Create Animation ([YouTube](https://youtu.be/Vshcptcxf-E))
- Add To Render Queue  ([YouTube](https://youtu.be/wJofiH1GeY4))
- Adobe Media Encoder ([YouTube](https://youtu.be/iDTcqOCJ8RE))
...
- **Content Creators** who want to elevate their content with professional motion graphics and animations

- **Creatives & Artists** ready to unlock After Effects' potential without feeling overwhelmed by its complexity

- **YouTubers** who want to add visual effects and interest to their videos, but want a clear and fast-paced path to getting up and running using After Effects.
