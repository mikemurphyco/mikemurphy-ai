---
title: "How To Use Cursor AI to Build a Wiggle Panel in Adobe After Effects"
description: "This free 4-part mini-course shows you how to use Cursor AI—an AI-powered code editor—to build a custom, dock-able Wiggle Panel inside Adobe After Effects. No coding experience required. Just curiosity, creativity, and a desire to build something cool from scratch."
pubDate: "2025-04-08T06:30:13"
updatedDate: "2025-04-10T13:33:18"
draft: false
type: "post"
slug: "cursorwiggle"
permalink: "/cursorwiggle/"
legacyPermalink: "https://www.mikemurphy.co/cursorwiggle/"
canonicalUrl: "https://mikemurphy.ai/tutorials/cursorwiggle/"
contentEra: "ai"
visibility: "public"
author: "Mike Murphy"
featuredImage: "/assets/media/2025/04/Wiggle.png"
featuredImageSource: "https://www.mikemurphy.co/wp-content/uploads/2025/04/Wiggle.png"
categories: 
  - "Adobe After Effects"
  - "AI"
  - "Cursor"
...
wp:
  ...
  rawWordCount: 1981
seo:
  legacyTitle: "How To Use Cursor AI to Build a Wiggle Panel in Adobe After Effects - Mike Murphy Co"
  legacyH1: "How To Use Cursor AI to Build a Wiggle Panel in Adobe After Effects"
  legacyCanonical: "https://www.mikemurphy.co/cursorwiggle/"
...
1.  Open web browser
2.  Visit <https://cursor.com>
3.  Click ‘Sign In’ and sign up for free account
4.  Click Download
5.  Install on Mac, Windows or Linux
6.  Click to Open Cursor App
7.  Tour the Interface

### ⌨️ **Cursor Keyboard Shortcuts:**

1.  Explorer Bar: Cmd/Ctrl + B
2.  Chat Panel: Cmd/Ctrl + i
3.  Send: Return/Enter
4.  New Chat: Cmd/Ctrl + N
5.  Open Terminal Panel: Cmd/Ctrl + J
...
1.  Create folder in Home Folder called ‘code’
2.  Create a folder inside ‘code’ called ‘code builds’
3.  Create a folder inside ‘code builds’ called ‘ae_script_panel_wiggle’
4.  Create 3 folders inside project folder (dev, docs, project files)
5.  Place Cursor code files (.jsx) in ‘dev’ folder
6.  Place ReadMe files and prompts in ‘docs’
7.  Place After Effects .aep project in ‘project files’
