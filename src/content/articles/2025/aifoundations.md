...
canonicalUrl: "https://mikemurphy.ai/aifoundations/"
contentEra: "ai"
visibility: "public"
author: "Mike Murphy"
...
- [ChatGPT](https://chatgpt.com/) - Conversational AI assistant
- [HeyGen](https://www.heygen.com/) - AI video generation
- [Midjourney](http://midjourney.com/) - AI image creation
...
- [Descript](https://descript.com/) - AI-powered video and audio editing
- [Lumen5](https://lumen5.com) - AI video creation from text
- [Runway](https://runwayml.com/) - Creative AI tools for video
...
- [H2O.ai](https://h2o.ai/) - Open-source ML platform
...
- [Deep Dream Generator](https://deepdreamgenerator.com/) - Neural network art generation
- [Netron](https://netron.app/) - Visualizer for neural network models
...
- [Claude](https://claude.ai/) - AI assistant with reasoning capabilities
- [Google Teachable Machine](https://teachablemachine.withgoogle.com/) - Train ML models easily
...
- [KNIME](https://www.knime.com/) - Data analytics and ML platform
- [Orange](https://orangedatamining.com/) - Visual programming for data science
- [Altair RapidMiner](https://altair.com/altair-rapidminer) - Data science platform
...
- [OpenAI Gym](https://github.com/openai/gym) - Toolkit for developing RL algorithms
- [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) - Train intelligent agents in games
...
- [DialogFlow](https://dialogflow.cloud.google.com/) - Build conversational interfaces
- [Grammarly](https://grammarly.com) - AI writing assistant
- [Hugging Face](https://huggingface.co/) - NLP models and tools
...
- [DeepAI](https://deepai.org/) - AI image tools and APIs
- [Landing AI](https://landing.ai/) - Computer vision platform
...
- [DALL-E](https://openai.com/dall-e) - AI image generation from text
- [Midjourney](https://midjourney.com) - AI art and image creation
...
- [MonkeyLearn](https://monkeylearn.com/) - No-code text classification
- [Google AutoML](https://cloud.google.com/automl) - Custom ML model training
- [Levity AI](https://levity.ai/) - Visual AI classification tool
...
- [PromptHero](https://prompthero.com/) - Prompt library and search
- [Anthropic Prompt Library](https://docs.anthropic.com/claude/prompt-library) - Claude prompt examples
...
- [DeepNote](https://deepnote.com/) - Collaborative data notebooks
...
- [Autotrain by HuggingFace](https://huggingface.co/autotrain) - Automated fine-tuning
- [OpenAI Fine-tuning](https://platform.openai.com/docs/guides/fine-tuning) - Fine-tune GPT models
- [Predibase](https://predibase.com/) - Fine-tune LLMs efficiently
...
- [IBM Watson](https://www.ibm.com/products/watson-studio) - AI and data platform
- [Qlik Sense](https://www.qlik.com/us) - Data analytics
- [RapidMiner](https://altair.com/altair-rapidminer) - Data science platform
...
- [OpenAI API](https://platform.openai.com/) - GPT models and DALL-E via API
- [Replicate](https://replicate.com/) - Run open-source AI models via API
- [Anthropic API](https://www.anthropic.com/api) - Claude AI via API
...
- [Kaggle](https://www.kaggle.com/learn) - Datasets and ML competitions
- [LabelBox](https://labelbox.com/) - Data labeling platform
- [Mostly AI](https://mostly.ai/) - Synthetic data generation
...
- [Fiddler](https://www.fiddler.ai/) - AI observability platform
- [Google What-If Tool](https://pair-code.github.io/what-if-tool/) - Analyze ML models
- [Microsoft Responsible AI Toolbox](https://responsibleaitoolbox.ai/) - AI fairness tools
...
- [HuggingFace Transformers](https://github.com/huggingface/transformers) - Pre-trained models library
- [PyTorch Hub](https://pytorch.org/hub/) - Pre-trained model repository
- [TensorFlow Hub](https://www.tensorflow.org/hub) - Reusable ML model library
...
- [Feature-Engine](https://feature-engine.trainindata.com/en/latest/) - Feature engineering library
...
- [LangSmith](https://www.langchain.com/langsmith) - LLM application testing
- [PromptLayer](https://www.promptlayer.com/) - Prompt management and tracking
- [Weights & Biases](https://wandb.ai/site/) - ML experiment tracking
...
- [AI Explainability 360](https://github.com/Trusted-AI/AIX360) - Open-source explainability toolkit
- [InterpretML](https://github.com/interpretml/interpret) - Model interpretation library
- [SHAP](https://github.com/shap/shap) - Explain ML model predictions
...
**Want to learn more about AI?** Follow my journey at [mikemurphy.co](https://mikemurphy.co) where I break down complex AI concepts into practical, actionable insights.
