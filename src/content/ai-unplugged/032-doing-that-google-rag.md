...
issue: 32
slug: "032"
subject: "Doing That Google RAG"
lede: "Google’s announced their new Gemini API File Search: It is a built-in RAG tool that lets you upload documents like PDFs, notes, code files, and have Gemini automatically index, chunk, and search them."
summary: "Google File Search for RAG leads this issue. The featured term is AGI. The tool spotlight is VS Code."
publishedAt: "2025-11-14T10:51:18+00:00"
sentAt: "2025-11-14T10:51:18+00:00"
tags: []
topics:
  - "AGI"
  - "Check out Gemini File Search"
  - "VS Code"
  - "check-out-gemini-file-search"
  - "vs-code"
source:
  provider: "beehiiv"
  url: "https://aiunplug.io/p/32"
  postId: "post_7383988d-ecec-46b0-984c-53441cb757e8"
agentReadable:
  summary120: "Google File Search for RAG leads this issue. The featured term is AGI. The tool spotlight is VS Code."
  keyClaims:
    - "Google File Search for RAG"
...
**Google’s announced their new Gemini API File Search:**
 ...
 👉[](https://grokipedia.com/?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)[Check out Gemini File Search](https://blog.google/technology/developers/file-search-gemini-api/?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)
...
**Visual Studio Code (VS Code)** is an open-source, free code editor from Microsoft that’s become the go-to workspace for developers (and me) and pretty much anyone working with AI tools. VS Code is a supercharged text editor where you can write code, run scripts, manage projects, use terminals, and plug in AI assistants like Claude Code or ChatGPT. It’s fast, customizable, and works with almost every language or workflow, making it the perfect “home base” for experimenting, building small automations, or learning to code without feeling overwhelmed.
 ...
 👉 [Check out VS Code (it’s free)](https://code.visualstudio.com/?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)
...
](https://code.visualstudio.com/?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)

### 🛠 What I Made: How To Install Claude Code Extension in VS Code
...
- How To Use Claude Code Features
 ...
 📺 [Watch Tutorial ](https://youtu.be/0FmT0uasKWw?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)[on YouTube](https://youtu.be/0FmT0uasKWw?utm_source=aiunplug.io&utm_medium=referral&utm_campaign=issue-32-doing-that-google-rag)
